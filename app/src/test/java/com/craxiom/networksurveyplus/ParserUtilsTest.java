...
public class ParserUtilsTest
{
    ...
    public void testCrcCalculation()
    {
        ...
        final byte[] bytes = {(byte) 0x31, (byte) 0x32, (byte) 0x33, (byte) 0x34, (byte) 0x35, (byte) 0x36, (byte) 0x37, (byte) 0x38, (byte) 0x39};

        final int crc = ParserUtils.calculateCrc16Ccitt(bytes);
    ...
    {
        final int expectedCrc = 0x532d;
        //final int expectedCrc = 0x2d53;
