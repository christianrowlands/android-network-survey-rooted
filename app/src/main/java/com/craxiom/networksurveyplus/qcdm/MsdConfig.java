...
public class MsdConfig
{
    ...
    {
        return true;
        // TODO return sharedPrefs(context).getBoolean("settings_enable_pcap_recording", true);
    }

    public static String getPcapFilenamePrefix(Context context)
    {
        return sharedPrefs(context).getString("settings_pcap_filename_prefix", Environment.getExternalStorageDirectory().getPath() + "/craxiom-qcdm");
    }
