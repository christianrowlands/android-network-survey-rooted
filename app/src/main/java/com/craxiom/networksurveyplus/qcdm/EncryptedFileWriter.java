...
public class EncryptedFileWriter
{
    ...
    private final boolean compressEncryptedFile;
    ...
    private final BlockingQueue<MsgWrapper> msgQueue = new LinkedBlockingQueue<MsgWrapper>();
    private OutputStream plaintextOutputStream;
    private final boolean compressPlaintextFile;
    ...
    public synchronized void close() throws EncryptedFileWriterError
    {
        ...
        try
        {
            ...
            wl = pm.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, context.getString(R.string.app_name) + ":closewakelock");
            wl.acquire();
